        ...
        >
          ...
          <CardHeader className="text-center pb-2 md:pb-4">
            ...
            <CardTitle className="text-[1.75rem] font-bold text-gray-900">
              Oops, that email’s already in use
            </CardTitle>
          </CardHeader>
          ...
          <CardContent className="text-center flex flex-col flex-grow justify-between pb-8 md:pb-12">
            <div>
              <p className="text-gray-600 mb-4 md:mb-6">
                It seems you already have an account.<br />
                Log in, or try signing up with another email.
              </p>
            </div>
            ...
            <div className="flex gap-4 mt-auto">
              ...
              <Link href="/login" className="flex-1">
                <Button
                  className="w-full bg-pink-100 hover:bg-pink-200 text-pink-600 transition-colors font-semibold"
                  size="sm"
                >
                  Go to Login
                </Button>
