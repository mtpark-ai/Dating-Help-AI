      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 landing-page-zoom">
        ...
        <section className="max-w-4xl mx-auto px-4 md:px-8 my-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-4 flex flex-col">
              <CardContent className="p-0 text-center flex flex-col flex-grow">
                ...
                <p className="text-sm md:text-sm text-gray-700 mb-4 flex-grow">Your Tinder, Bumble, Hinge Dating App AI Opener</p>

                {/* Single Function Button */}
                <div className="flex justify-center mt-auto p-2">
                  <Link href="/pickup-lines" className="w-full md:w-1/2">
                    <Button className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-semibold py-4 md:py-3 px-6 md:px-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-base md:text-sm min-h-[48px] touch-manipulation">
                      Upload Profile
                    </Button>
                  </Link>
                </div>
            ...
            <Card className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-4 flex flex-col">
              <CardContent className="p-0 text-center flex flex-col flex-grow">
                ...
                <p className="text-sm md:text-sm text-gray-700 mb-4 flex-grow">AI-Powered Dating Success</p>

                {/* Two Function Buttons */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-auto p-2">
                  <Link href="/upload-screenshot">
                    <Button className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-semibold py-4 md:py-3 px-4 md:px-3 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-base md:text-sm min-h-[48px] touch-manipulation">
                      Upload Screenshot
                    </Button>
                  </Link>

                  <Link href="/conversation">
                    <Button className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white font-semibold py-4 md:py-3 px-4 md:px-3 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-base md:text-sm min-h-[48px] touch-manipulation">
                      Type Conversation
                    </Button>
                  </Link>
                </div>
         ...
         <section className="max-w-screen-lg mx-auto px-4 md:px-8 py-12">
          <div className="text-center mb-16">
            ...
            <p className="text-base md:text-lg text-gray-700">Your Tinder, Bumble, Hinge Dating App AI Coach</p>
          </div>
        ...
        <section className="bg-gradient-to-r from-gray-50 to-gray-100 py-12 my-16">
          <div className="max-w-screen-lg mx-auto px-4 md:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-base md:text-lg text-gray-700">Get started in just a few simple steps</p>
            </div>
        ...
        <section className="max-w-screen-lg mx-auto px-4 md:px-8 py-12">
          <div className="text-center mb-16">
            ...
            <p className="text-base md:text-lg text-gray-700">Everything you need to know about Dating Help AI</p>
          </div>
              ...
              <form onSubmit={handleSubmitQuestion} className="px-6 pb-6 pt-4 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-gray-900 placeholder-gray-600"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-600"
                  />
                </div>
        ...
        {showSuccessModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 text-center">
              ...
              <p className="text-gray-700 mb-6">Thank you for your question! We'll get back to you as soon as possible.</p>
              <Button
