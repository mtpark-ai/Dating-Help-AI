    ...
    <header className="w-full py-4 md:py-6 px-4 md:px-8">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center flex-1 justify-evenly ml-8 lg:ml-10">
          <div className="relative group">
            ...
            <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-20 min-w-48">
              <Link
                ...
                className="block px-4 py-4 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors duration-200 border-b border-gray-100 min-h-[48px] flex items-center touch-manipulation"
              >
                Upload Screenshot
              </Link>
              <Link
                href="/conversation"
                className="block px-4 py-4 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors duration-200 min-h-[48px] flex items-center touch-manipulation"
              >
                Type a Conversation
              </Link>
          ...
          <div className="relative group">
            <span className="text-[15px] md:text-base lg:text-[17px] text-gray-600 cursor-default font-medium whitespace-nowrap">Dating Profile Review</span>
          ...
          <div className="relative group">
            <span className="text-[15px] md:text-base lg:text-[17px] text-gray-600 cursor-default font-medium whitespace-nowrap">Dating App Photo</span>
            <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-2 py-1 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
              Launching Soon
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-b-4 border-transparent border-b-gray-900"></div>
            </div>
          ...
          <div className="py-3">
            ...
            <div className="px-5 py-4 border-b border-gray-100">
              ...
              <div className="space-y-3">
                <Link
                  href="/upload-screenshot"
                  className="block px-4 py-4 text-base text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors duration-200 rounded-lg min-h-[48px] flex items-center touch-manipulation"
            ...
            <div className="px-5 py-4 border-b border-gray-100">
              <div className="text-base text-gray-600">Dating Profile Review</div>
              <div className="text-sm text-gray-700 mt-1">Launching Soon</div>
            </div>

            {/* Dating App Photo */}
            <div className="px-5 py-4">
              <div className="text-base text-gray-600">Dating App Photo</div>
              <div className="text-sm text-gray-700 mt-1">Launching Soon</div>
            </div>
          </div>
        </div>
