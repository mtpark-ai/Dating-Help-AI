      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-gray-700 hover:text-purple-600 transition-colors duration-200 block py-2 min-h-[48px] flex items-center touch-manipulation">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/admin/questions" className="text-gray-700 hover:text-purple-600 transition-colors duration-200 block py-2 min-h-[48px] flex items-center touch-manipulation">
                  Admin
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/upload-screenshot" className="text-gray-700 hover:text-purple-600 transition-colors duration-200 block py-2 min-h-[48px] flex items-center touch-manipulation">
                  Upload Screenshot
                </Link>
              </li>
              <li>
                <Link
                  href="/conversation"
                  className="text-gray-700 hover:text-purple-600 transition-colors duration-200 block py-2 min-h-[48px] flex items-center touch-manipulation"
                >
                  Type a Conversation
                </Link>
              </li>
              ...
              <li className="relative group">
                <span className="text-gray-600 cursor-default font-medium whitespace-nowrap">Profile Review</span>
              ...
              <li className="relative group">
                <span className="text-gray-600 cursor-default font-medium whitespace-nowrap">AI Enhanced Photos</span>
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-2 py-1 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
                  Launching Soon
                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-b-4 border-transparent border-b-gray-900"></div>
                </div>
        ...
        <div className="border-t border-gray-300 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-700 text-sm">© 2024 Dating Help AI. All rights reserved.</div>
